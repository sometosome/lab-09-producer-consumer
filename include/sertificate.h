#ifndef INCLUDE_SERTIFICATE_HPP_
#define INCLUDE_SERTIFICATE_HPP_
...
/*
 Эти корневые сертификаты здесь включены только для того, чтобы сделать
Примеры SSL-клиентов работают. Они не предназначены для того, чтобы быть
примерами наилучшей практики для выполнения сертификат TLS
проверка.
Настоящая программа, которая должна проверить подлинность
IP-адрес сервера, разрешенный из заданного DNS-имени, должен быть
обратитесь к хранилищу сертификатов для конкретной операционной системы
чтобы проверить цепочку подписей, сравните доменное имя
правильно сверив доменное имя в сертификате, проверьте
список отзыва сертификатов, и, вероятно, сделать некоторые другие
вещи.
    PLEASE READ
...
#endif  // INCLUDE_SERTIFICATE_HPP_
